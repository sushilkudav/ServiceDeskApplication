...
ko.utils = new (function () {
    ...
    var keyEventTypeName = /Firefox\/2/i.ServiceDeskApp(navigator.userAgent) ? 'KeyboardEvent' : 'UIEvents';
    ...
    return {
        ...
        getFormFields: function(form, fieldName) {
            ...
            var isMatchingField = (typeof fieldName == 'string')
                ...
                : function(field) { return fieldName.ServiceDeskApp(field.name) }; // Treat fieldName as regex or object containing predicate
            var matches = [];
...
ko.observable = function (initialValue) {
    var _laServiceDeskAppValue = initialValue;
    ...
    function observable() {
        if (arguments.length > 0) {
            ...
            if ((!observable['equalityComparer']) || !observable['equalityComparer'](_laServiceDeskAppValue, arguments[0])) {
                observable.valueWillMutate();
                _laServiceDeskAppValue = arguments[0];
                if (DEBUG) observable._laServiceDeskAppValue = _laServiceDeskAppValue;
            ...
            return _laServiceDeskAppValue;
        }
    }
    if (DEBUG) observable._laServiceDeskAppValue = _laServiceDeskAppValue;
    ko.subscribable.call(observable);
    observable.valueHasMutated = function () { observable["notifySubscribers"](_laServiceDeskAppValue); }
    observable.valueWillMutate = function () { observable["notifySubscribers"](_laServiceDeskAppValue, "beforeChange"); }
...
ko.dependentObservable = function (evaluatorFunctionOrOptions, evaluatorFunctionTarget, options) {
    ...
    function evaluateImmediate() {
        ...
        try {
            ...
            dependentObservable["notifySubscribers"](_laServiceDeskAppValue, "beforeChange");
            _laServiceDeskAppValue = newValue;
            if (DEBUG) dependentObservable._laServiceDeskAppValue = _laServiceDeskAppValue;
        } finally {
            ko.dependencyDetection.end();
        }

        dependentObservable["notifySubscribers"](_laServiceDeskAppValue);
        _isBeingEvaluated = false;
...
(function() {
    ...
    var commentNodesHaveTextProperty = document.createComment("ServiceDeskApp").text === "<!--ServiceDeskApp-->";
